...
! V-WINDS 'W'
 ...
 integer                          :: id_t, id_delp, id_time, id_lev
...
!--- define dimensions
 ...
 !--- define fields
     error = nf90_def_var(ncid, 'xaxis_1', NF90_DOUBLE, (/dim_lon/), id_x1)
     call netcdf_err(error, 'DEFINING XAXIS_1 FIELD' )
     error = nf90_put_att(ncid, id_x1, "long_name", "xaxis_1")
     call netcdf_err(error, 'DEFINING XAXIS_1 LONG NAME' )
     error = nf90_put_att(ncid, id_x1, "units", "none")
     call netcdf_err(error, 'DEFINING XAXIS_1 UNITS' )
     error = nf90_put_att(ncid, id_x1, "cartesian_axis", "X")
     call netcdf_err(error, 'WRITING XAXIS_1 FIELD' )

     error = nf90_def_var(ncid, 'xaxis_2', NF90_DOUBLE, (/dim_lonp/), id_x2)
     call netcdf_err(error, 'DEFINING XAXIS_2 FIELD' )
     error = nf90_put_att(ncid, id_x2, "long_name", "xaxis_2")
     call netcdf_err(error, 'DEFINING XAXIS_2 LONG NAME' )
     error = nf90_put_att(ncid, id_x2, "units", "none")
     call netcdf_err(error, 'DEFINING XAXIS_2 UNITS' )
     error = nf90_put_att(ncid, id_x2, "cartesian_axis", "X")
     call netcdf_err(error, 'WRITING XAXIS_2 FIELD' )


     error = nf90_def_var(ncid, 'yaxis_1', NF90_DOUBLE, (/dim_latp/), id_y1)
     call netcdf_err(error, 'DEFINING YAXIS_1 FIELD' )
     error = nf90_put_att(ncid, id_y1, "long_name", "yaxis_1")
     call netcdf_err(error, 'DEFINING YAXIS_1 LONG NAME' )
     error = nf90_put_att(ncid, id_y1, "units", "none")
     call netcdf_err(error, 'DEFINING YAXIS_1 UNITS' )
     error = nf90_put_att(ncid, id_y1, "cartesian_axis", "Y")
     call netcdf_err(error, 'WRITING YAXIS_1 FIELD' )

     error = nf90_def_var(ncid, 'yaxis_2', NF90_DOUBLE, (/dim_lat/), id_y2)
     call netcdf_err(error, 'DEFINING YAXIS_2 FIELD' )
     error = nf90_put_att(ncid, id_y2, "long_name", "yaxis_2")
     call netcdf_err(error, 'DEFINING YAXIS_2 LONG NAME' )
     error = nf90_put_att(ncid, id_y2, "units", "none")
     call netcdf_err(error, 'DEFINING YAXIS_2 UNITS' )
     error = nf90_put_att(ncid, id_y2, "cartesian_axis", "Y")
     call netcdf_err(error, 'WRITING YAXIS_2 FIELD' )


     error = nf90_def_var(ncid, 'zaxis_1', NF90_DOUBLE, (/dim_lev/), id_z1)
     call netcdf_err(error, 'DEFINING ZAXIS_1 FIELD' )
     error = nf90_put_att(ncid, id_z1, "long_name", "zaxis_1")
     call netcdf_err(error, 'DEFINING ZAXIS_1 LONG NAME' )
     error = nf90_put_att(ncid, id_z1, "units", "none")
     call netcdf_err(error, 'DEFINING ZAXIS_1 UNITS' )
     error = nf90_put_att(ncid, id_z1, "cartesian_axis", "Z")
     ...
     error = nf90_def_var(ncid, 'u', NF90_DOUBLE,(/dim_x,dim_latp,dim_lev,dim_time/),id_u)
     call netcdf_err(error, 'DEFINING U' )
     error = nf90_put_att(ncid, id_u, "long_name", "u")
     call netcdf_err(error, 'DEFINING U LONG NAME' )
     error = nf90_put_att(ncid, id_u, "units", "none")
     call netcdf_err(error, 'DEFINING U UNITS' )

     error = nf90_def_var(ncid, 'v', NF90_DOUBLE,(/dim_lonp,dim_lat,dim_lev,dim_time/),id_v)
     call netcdf_err(error, 'DEFINING V' )
     error = nf90_put_att(ncid, id_v, "long_name", "v")
     call netcdf_err(error, 'DEFINING V LONG NAME' )
     error = nf90_put_att(ncid, id_v, "units", "none")
     call netcdf_err(error, 'DEFINING V UNITS' )
     ...
     call netcdf_err(error, 'DEFINING W LONG NAME' )
     error = nf90_put_att(ncid, id_w, "units", "none")
     call netcdf_err(error, 'DEFINING W UNITS' )
     ...
     call netcdf_err(error, 'DEFINING DZ LONG NAME' )
     error = nf90_put_att(ncid, id_dz, "units", "none")
     call netcdf_err(error, 'DEFINING DZ UNITS' )
     ...
     call netcdf_err(error, 'DEFINING T LONG NAME' )
     error = nf90_put_att(ncid, id_t, "units", "none")
     call netcdf_err(error, 'DEFINING T UNITS' )
     ...
     call netcdf_err(error, 'DEFINING phis LONG NAME' )
     error = nf90_put_att(ncid, id_phis, "units", "none")
     call netcdf_err(error, 'DEFINING phis UNITS' )

     error = nf90_def_var(ncid, 'ua', NF90_DOUBLE,(/dim_lon,dim_lat,dim_lev,dim_time/),id_ua)
     call netcdf_err(error, 'DEFINING ua' )
     error = nf90_put_att(ncid, id_ua, "long_name", "ua")
     call netcdf_err(error, 'DEFINING ua LONG NAME' )
     error = nf90_put_att(ncid, id_ua, "units", "none")
     call netcdf_err(error, 'DEFINING ua UNITS' )

     error = nf90_def_var(ncid, 'va', NF90_DOUBLE,(/dim_lon,dim_lat,dim_lev,dim_time/),id_va)
     call netcdf_err(error, 'DEFINING va' )
     error = nf90_put_att(ncid, id_va, "long_name", "va")
     call netcdf_err(error, 'DEFINING va LONG NAME' )
     error = nf90_put_att(ncid, id_va, "units", "none")
     call netcdf_err(error, 'DEFINING va UNITS' )
