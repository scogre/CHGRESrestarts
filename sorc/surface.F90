...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 type(esmf_field), public           :: vegstate_type_target_grid
 type(esmf_field), public           :: zorlstate_target_grid
 type(esmf_field), public           :: tseastate_target_grid
 type(esmf_field), public           :: canopystate_target_grid
 type(esmf_field), public           :: slcstate_target_grid
 type(esmf_field), public           :: smcstate_target_grid
...
!---------------------------------------------------------------------------------------------
! SG SG SG SG SG ---------
 print*,"-SG_CALLING_SURFACE_WRITE"
...
!---------------------------------------------------------------------------------------------
 ...
 use input_data, only                : canopy_mc_input_grid,  &
                                       ...
                                       mxsno_albedo_input_grid, &
                                       slope_type_input_grid, &
                                       soil_type_input_grid,  &
                                       substrate_temp_input_grid,  &
 ...
 type(esmf_routehandle)             :: regrid_land_2d
 type(esmf_routehandle)             :: regrid_land_3d
 type(esmf_routehandle)             :: regrid_landice
 type(esmf_routehandle)             :: regrid_landice_3d
 type(esmf_routehandle)             :: regrid_nonland
 type(esmf_routehandle)             :: regrid_seaice
 type(esmf_routehandle)             :: regrid_seaice_3d
...
!!!!!!!!
!!!!!!!!
 print*,"- CALL Field_Regrid alvsf."
 call ESMF_FieldRegrid(alvsf_input_grid, &
                       alvsf_target_grid, &
                       routehandle=regrid_bl_no_mask, &
                       termorderflag=ESMF_TERMORDER_SRCSEQ, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
 ...
 print*,"- CALL Field_Regrid alvwf."
 call ESMF_FieldRegrid(alvwf_input_grid, &
                       alvwf_target_grid, &
                       routehandle=regrid_bl_no_mask, &
                       termorderflag=ESMF_TERMORDER_SRCSEQ, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
 ...
 print*,"- CALL Field_Regrid alnsf."
 call ESMF_FieldRegrid(alnsf_input_grid, &
                       alnsf_target_grid, &
                       routehandle=regrid_bl_no_mask, &
                       termorderflag=ESMF_TERMORDER_SRCSEQ, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
 ...
 print*,"- CALL Field_Regrid alnwf."
 call ESMF_FieldRegrid(alnwf_input_grid, &
                       alnwf_target_grid, &
                       routehandle=regrid_bl_no_mask, &
                       termorderflag=ESMF_TERMORDER_SRCSEQ, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
 ...
 print*,"- CALL Field_Regrid facsf."
 call ESMF_FieldRegrid(facsf_input_grid, &
                       facsf_target_grid, &
                       routehandle=regrid_bl_no_mask, &
                       termorderflag=ESMF_TERMORDER_SRCSEQ, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
 ...
 print*,"- CALL Field_Regrid facwf."
 call ESMF_FieldRegrid(facwf_input_grid, &
                       facwf_target_grid, &
                       routehandle=regrid_bl_no_mask, &
                       termorderflag=ESMF_TERMORDER_SRCSEQ, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
 ...
 print*,"- CALL Field_Regrid max_veg_greenness."
 ...
 print*,"- CALL Field_Regrid min_veg_greenness."
 ...
 print*,"- CALL Field_Regrid mxsno_albedo."
 call ESMF_FieldRegrid(mxsno_albedo_input_grid, &
...
! print*,"- CALL Field_Regrid slope_type."
! call ESMF_FieldRegrid(slope_type_input_grid, &
...
! print*,"- CALL Field_Regrid soil_type."
...
!    call mpi_abort
 ...
 print*,"- CALL Field_Regrid substrate_temp."
 call ESMF_FieldRegrid(substrate_temp_input_grid, &
 ...
 print*,"- CALL Field_Regrid veg_greenness."
...
! print*,"- CALL Field_Regrid veg_type."
...
!    call mpi_abort
 ...
 print*,"- CALL Field_Regrid skin_temp."
 ...
 print*,"- CALL Field_Regrid canopystate."
...
!!!!!!HERE
 print*,"- CALL Field_Regrid slcstate."
 ...
 print*,"- CALL Field_Regrid smcstate."
...
!---------------------------------------------------------------------------------------------
 ...
 print*,"- CALL FieldRegridRelease."
 call ESMF_FieldRegridRelease(routehandle=regrid_seaice_3d, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
    call mpi_abort
 ...
 print*,"- CALL FieldRegridStore for sea ice fields."
 call ESMF_FieldRegridStore(seaice_depth_input_grid, &
...
!---------------------------------------------------------------------------------------------
 ...
 print*,"- CALL FieldRegridStore for 3d landice fields."
 call ESMF_FieldRegridStore(soil_temp_input_grid, &
                            soil_temp_target_grid, &
                            srcmaskvalues=(/0/), &
                            dstmaskvalues=(/0/), &
 ...
 print*,"- CALL FieldRegridRelease."
 call ESMF_FieldRegridRelease(routehandle=regrid_landice_3d, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
    call mpi_abort

 isrctermprocessing = 1
 print*,"- CALL FieldRegridStore for 2d landice fields."
 call ESMF_FieldRegridStore(skin_temp_input_grid, &
                            skin_temp_target_grid, &
                            srcmaskvalues=(/0/), &
                            dstmaskvalues=(/0/), &
...
!---------------------------------------------------------------------------------------------
 ...
 print*,"- CALL FieldRegridRelease."
 call ESMF_FieldRegridRelease(routehandle=regrid_land_3d, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
    call mpi_abort

 isrctermprocessing = 1
 print*,"- CALL FieldRegridStore for 2d land (but no land ice) fields."
 call ESMF_FieldRegridStore(skin_temp_input_grid, &
                            skin_temp_target_grid, &
                            srcmaskvalues=(/0/), &
                            dstmaskvalues=(/0/), &
 ...
 print*,"- CALL FieldRegridRelease."
 call ESMF_FieldRegridRelease(routehandle=regrid_land_2d, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
    call mpi_abort
...
!!!!
!!!!
 print*,"- CALL FieldCreate FOR TARGET GRID formerly static variables."
 ...
 vegstate_type_target_grid = ESMF_FieldCreate(target_grid, &
                                    typekind=ESMF_TYPEKIND_R8, &
                                    staggerloc=ESMF_STAGGERLOC_CENTER, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
    call mpi_abort

 zorlstate_target_grid = ESMF_FieldCreate(target_grid, &
                                    typekind=ESMF_TYPEKIND_R8, &
                                    staggerloc=ESMF_STAGGERLOC_CENTER, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__))&
    call mpi_abort

 tseastate_target_grid = ESMF_FieldCreate(target_grid, &
                                    typekind=ESMF_TYPEKIND_R8, &
                                    staggerloc=ESMF_STAGGERLOC_CENTER, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__))&
    call mpi_abort

 canopystate_target_grid = ESMF_FieldCreate(target_grid, &
                                    typekind=ESMF_TYPEKIND_R8, &
                                    staggerloc=ESMF_STAGGERLOC_CENTER, rc=rc)
 if(ESMF_logFoundError(rcToCheck=rc,msg=ESMF_LOGERR_PASSTHRU,line=__line__,file=__file__)) &
    call mpi_abort
...
!!!!!!!!!! HERE
!!!!!!!!!!!!!!!!
 slcstate_target_grid = ESMF_FieldCreate(target_grid, &
                                   typekind=ESMF_TYPEKIND_R8, &
 ...
 smcstate_target_grid = ESMF_FieldCreate(target_grid, &
                                   typekind=ESMF_TYPEKIND_R8, &
                                   staggerloc=ESMF_STAGGERLOC_CENTER, &
                                   ungriddedLBound=(/1/), &
                                   ungriddedUBound=(/lsoil_target/), rc=rc)
...
!!!!
 ...
 call ESMF_FieldDestroy(vegstate_type_target_grid, rc=rc)
 call ESMF_FieldDestroy(zorlstate_target_grid, rc=rc)
 call ESMF_FieldDestroy(tseastate_target_grid, rc=rc)
 call ESMF_FieldDestroy(canopystate_target_grid, rc=rc)
!!!!!!!!! HERE
 call ESMF_FieldDestroy(slcstate_target_grid, rc=rc)
 call ESMF_FieldDestroy(smcstate_target_grid, rc=rc)
!!!!!!!!! HERE
